...
export class AppComponent  implements OnInit
{
    ...
    serviceSelectorCategory = new Category(this.expressionsService.getServiceSelector(), true);
...
//--------------------------------------------------------------------------------------------------------------------------------
    ...
    capture(content)
    {
        ...
        html2canvas(document.getElementById("capture"), options).then(canvas =>
        {
            ...
            this.image = this.writeExif(imageData);
        ...
        const userComment =
            {
                ...
                "8":
                    [
                        ...
                        this.convertInchesToCentimeters((12*this.heightFeet) + this.heightInches)
                    ],
                "9":
                    [
                        this.weight.toString() + "lbs",
                        this.convertPoundsToKilograms(this.weight)
                    ],
                "10": this.getName(this.genderCategory.getSelectedExpression()),
    ...
    writeExif(imageData: string)
    {
        ...
        zerothIfd[piexif.ImageIFD.ImageDescription] = "{\"url\": \"https://rainbowmenu.earth\", \"version\": \"v1.3.0\"}";
        exifIfd[piexif.ExifIFD.UserComment] = JSON.stringify(this.getObject());
    ...
    ngOnInit()
    {
        this.serviceSelectorCategory.setSelectedExpression(1);
        this.addRate();
    }
}
